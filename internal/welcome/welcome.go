...
func Options() []Option {
	return []Option{
		...
		{Key: 5, Label: "Engadir varias transaccións"},
		{Key: 6, Label: "Eliminar transacción"},
		{Key: 7, Label: "Pechar mes (resultados)"},
		{Key: 8, Label: "Limpar mes"},
		{Key: 9, Label: "Engadir resultado mensual"},
		{Key: 10, Label: "Eliminar resultado mensual"},
		{Key: 11, Label: "Engadir dividendo mensual"},
		{Key: 12, Label: "Eliminar dividendo mensual"},
		...
		{Key: 16, Label: "Ver resultado xeral (historial total)"},
		{Key: 17, Label: "Ver informe mensual total"},
		{Key: 18, Label: "Ver historial dun activo"},
		{Key: 0, Label: "Saír"},
	}
}
